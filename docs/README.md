...
`done/` describes what is built and verified. Everything at this level is either
user-facing or not yet implemented.

## Start here

| | |
|---|---|
| [USAGE.md](USAGE.md) | how to build, link and use it — with recipes and pitfalls |
| [INTEGRATION.md](INTEGRATION.md) | lifecycle inside the game: RED4ext, CET, shutdown, and what happens at game close |
| [API.md](API.md) | your five requested calls, mapped to what exists |
| [../README.md](../README.md) | overview and measured numbers |

## Implemented — research and design

The reverse-engineering notes and the decisions that came out of them. Each says
what was found, what was built, and what was deliberately left out.

| | |
|---|---|
| [done/archive-format.md](done/archive-format.md) | the `.archive` container: index, segments, Kraken, why the index is mapped rather than copied |
...
| [done/caching.md](done/caching.md) | the persistent mesh cache and its invalidation |
| [done/verification.md](done/verification.md) | how correctness was established — four independent oracles |
